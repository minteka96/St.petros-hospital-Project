...
// Vacancy API
export const fetchVacancies = () => axios.get(`${API_URL}/vacancies`);
export const addVacancy = (vacancy) => axios.post(`${API_URL}/vacancies`, vacancy);
export const deleteVacancy = (id) => axios.delete(`${API_URL}/vacancies/${id}`);
...
// News Detail API
export const addNewsDetail = (newsDetail) => axios.post(`${API_URL}/news/details`, newsDetail); // Add this line
