...
const DrTbTreatment = () => {
  ...
  <p>
    The DR-TB department specializes in the diagnosis, treatment, and management of drug-resistant forms of tuberculosis, which are resistant to first-line anti-TB drugs. Our department is equipped to handle cases of Multi-Drug Resistant TB (MDR-TB) and Extensively Drug-Resistant TB (XDR-TB) with a dedicated team of specialists and cutting-edge facilities. TGH provides a range of services, including:
  </p>
  <ul>
    <li>Drug susceptibility testing</li>
    <li>Second-line anti-TB drug therapy</li>
    <li>Individualized patient care and monitoring</li>
    <li>Comprehensive counseling and support services</li>
    <li>Outreach programs and community support</li>
    <li>Advanced diagnostic imaging and laboratory facilities</li>
  </ul>
</div>
      ...
      <div className={classes.departmentArea}>
        ...
        <div className={classes.contentWrapper}>
          ...
          <div className={`swiper-container department-gallery ${classes.departmentGallery}`} id="gallery">
            ...
            <div className="swiper-wrapper gallery-slider">
              ...
              <div className="swiper-slide" style={{ backgroundImage: `url(${img2})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className="slider-content">
                  <p className="title" style={{ color: '#00796b', fontSize: '50px' }}>
          ...
          <div className={classes.headOfDepartment} id="team">
            ...
            <h5 className={classes.departmentHeadName}>Dr.Mehiret </h5>
