...
const Pharmacy = () => {
  ...
  <p>
    Comprehensive care and services for all pharmaceutical needs. 
  </p>
  <p>
    The pharmacy department is specialized in providing safe and effective medications to patients. Our pharmacists are highly skilled in managing prescriptions, counseling on medication usage, and offering advice on drug interactions and side effects. TGH Pharmacy ensures the availability of high-quality medicines and pharmaceutical care services, including:
  </p>
  <ul>
    ...
    <li>Drug interaction checks and safety monitoring</li>
    <li>Compounding and specialty medications</li>
  </ul>
</div>
