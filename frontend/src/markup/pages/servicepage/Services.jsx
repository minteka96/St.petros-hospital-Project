...
function Services() {
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title text-center">
                <p>Our services</p>
                <h2 className="title"><span>Best Solution</span> For Your Health</h2>
              </div>
            </div>
          </div>
          <div className="row">
              ...
              <div className="row service-style2">
                ...
                <div className="col-sm-6 col-md-6 col-lg-3 service-item">
                  ...
                  <div className="content">
                    ...
                    <p>Advanced care for heart conditions including heart disease prevention, diagnosis, and treatment options like surgeries and therapy.</p>
  ...
  <div className="content">
    ...
    <p>Comprehensive dental care services, including preventive, restorative, and cosmetic treatments for a healthy smile.</p>
...
<div className="col-sm-6 col-md-6 col-lg-3 service-item">
  ...
  <div className="content">
    ...
    <p>Advanced laboratory services providing precise diagnostic results to guide treatment.</p>
    ...
    <a className="btn-link" href="/servicedetail/imaging">More <i className="icofont-simple-right"></i></a>
                ...
                <div className="col-sm-6 col-md-6 col-lg-3 service-item">
                  ...
                  <div className="content">
                    ...
                    <p>Comprehensive eye care, including routine check-ups, cataract surgeries, and advanced treatments for eye diseases.</p>
      ...
      More <i className="icofont-simple-right"></i>
                ...
                <div className="col-sm-6 col-md-6 col-lg-3 service-item">
                  ...
                  <div className="content">
                    ...
                    <p>Comprehensive mental health care including counseling, therapy, and psychiatric interventions for mental well-being.</p>
