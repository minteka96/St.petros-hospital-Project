  ...
  return (
    <div>
      ...
      <section className="flex">
        ...
        <div className="md:block hidden w-1/6 fixed left-0 h-screen bg-white border-r flex flex-col justify-between">
        ...
        <section className="md:w-3/4 ">
            ...
            <div className="relative">
              ...
              <div className="w-full leading-relaxed text-justify text-gray-700">
                <p className="mb-3 text-left rtl:text-right dark:text-gray-500 px-4">
                  St. Peter Specialized Hospital training center was renovated
                  by USAID/TB CARE I. The training center was inaugurated on 5
                  February 2013. The Hospital requested a position for the
                  center from civil service, Ethiopia to consider it as one of
                  the departments and to start work officially. The required
                  office for training and cafeteria materials and equipment are
                  fulfilled by TB CARE 1. St. Peter Specialized Hospital has
                  assigned professionals such as a training coordinator,
                  training officer, and other supportive staff. The organized
                  training team started work from scratch.
                </p>
                ...
                {showMore && (
                  <>
                    <p className="mb-3 text-left rtl:text-right dark:text-gray-500 px-4">
                      ...
                      sharing from an experienced training center, especially
                      from ALERT training center. Based on this, they started
                      writing proposals to partners to link to the Hospital’s
                      focused areas on TB and MDR-TB. The first partners that
                      worked with our training center were TB CARE 1 and WHO,
                      Ethiopia, who funded us for programmatic management of
                      drug-resistant TB, TB infection control, and second-line
                      drug supply management training respectively.
                    </p>
                    <p className="mb-3 text-left rtl:text-right dark:text-gray-500 px-4">
                    ...
                    <p className="mb-3 text-left rtl:text-right dark:text-gray-500 px-4">
                      ...
                      training will primarily target frontline healthcare
                      workers who interact regularly with individuals in both
                      clinical and community settings. Frontliners have the
                      potential to positively impact public health and would
                      greatly benefit from increased public health knowledge.
                    </p>
                    <p className="mb-3 text-left rtl:text-right dark:text-gray-500 px-4">
                      ...
                      training centers in Ethiopia. In-service training is a
                      staff development process aimed at improving employee
                      performance within their assigned job responsibilities. In
                      the health sector, it is designed to strengthen the
                      competencies of health workers, ensuring they have the
                      latest knowledge and mastery of techniques according to
                      scientific information and standardized practices.
                    </p>
                    <p className="mb-3 text-left rtl:text-right dark:text-gray-500 px-4">
                      Institutionalization of in-service training builds the
                      capacity of local training institutions to design and
                      deliver need-based training for healthcare workers. The
                      goal of the training center is to enhance professionals’
                      knowledge, skills, and attitudes in their areas of work.
                      The training service is integrated with clinical service
                      to fill gaps identified through training needs
                      assessments. St. Peter Specialized Hospital is a center of
                      excellence in TB and is the ideal training site for TB,
                      TB/HIV, and MDR-TB, along with other comprehensive
                    ...
                    <p className="mb-3 text-left rtl:text-right dark:text-gray-500 px-4">
                      ...
                      national and regional health bureaus, including the
                      federal ministry of health. The training center has
                      trained many healthcare workers in various disciplines
                      based on performance need assessments. The training
                      center’s performance from September 2013 to July 2016 is
                      detailed at the end of this portfolio. The center also
                      accommodates trainees who self-sponsor their training.
                    </p>
                  </>
                )}
            ...
            <div className="lg:flex ">
              ...
              <div className="w-full lg:w-1/2 pr-6">
                ...
                <p className="text-lg text-gray-700">
                  ...
                  Please make sure to follow the steps correctly to complete
                  your registration.
                </p>
                ...
                <ol className="list-decimal ml-5 text-lg text-gray-700">
                  ...
                  <li className="mb-2">
                    Submit the form and await a confirmation notification from
                    our team.
                  </li>
                  <li>
                    For any queries or issues during registration, please
          ...
          >
            ...
            {isCertified ? (
              ...
              <section className="relative w-full md:flex md:flex-wrap  lg:items-center ">
                <div className="md:w-1/2 w-auto px-4 py-12 md:px-6 md:py-16 lg:w-1/2 lg:px-8 lg:py-24">
                ...
                <div className="md:block hidden relative h-64 w-1/2 sm:h-96 lg:h-full lg:w-1/2">
                  <img
                    alt=""
                    src={certificate}
                    className="absolute inset-0 my-auto  object-cover"
                  />
                </div>
              </section>
            )}
