      ...
      <section>
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  value={formData.grandFathersName}
                  onChange={handleChange}
                />
              </td>
            </tr>
            ...
            <tr>
              <td>Physical/Health Defects</td>
              <td>
                <textarea
                  name="physicalHealthDefects"
                  value={formData.physicalHealthDefects}
                  onChange={handleChange}
                />
              </td>
            </tr>
            <tr>
              <td>History of Legal Issues</td>
              <td>
                <select
                  name="legalHistory"
            ...
            <tr>
              <td>
                Is there someone working at St. Peter Hospital who already knows
                your marital or family relationship status or has a personal
                connection with you?
              </td>
              <td>
                <select
                  name="relationshipWithHospital"
                  value={formData.relationshipWithHospital}
                  onChange={handleChange}
                >
                  <option value="no">No</option>
                  <option value="yes">Yes</option>
            ...
            {formData.relationshipWithHospital === "yes" && (
              <tr>
                <td>
                  If yes, please list the persons name and your relationship
                  status with them:
                </td>
                <td>
                  <input
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="text"
                      name={`languageStatus.read.${index}`}
                      value={language.read}
                      onChange={(e) => handleChange(e, index)}
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="text"
                      name={`languageStatus.write.${index}`}
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="text"
                      name={`languageStatus.speak.${index}`}
                ...
                <tr>
                  <td>Hearing Ability</td>
                  <td>
                    <input
                      type="text"
                      name={`languageStatus.hear.${index}`}
                      value={language.hear}
                      onChange={(e) => handleChange(e, index)}
                    />
                  </td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="text"
                      name={`workExperience[${index}].professionName`}
                      value={experience.professionName}
                      onChange={handleChange}
                    />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="text"
                      name={`workExperience[${index}].qualification`}
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="text"
                      name={`workExperience[${index}].reasonForRelease`}
                      value={experience.reasonForRelease}
                      onChange={handleChange}
                    />
                  </td>
                </tr>
